...
class ReaderSettings {
  ...
  ReaderSettings copyWith({
    ...
    bool? selectableText, String? orientation, String? readerTheme,
  }) {
...
/// Reader settings page (standalone route)
class ReaderSettingsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      body: const Center(child: Text('Settings are accessible from the reader')),
    );
  }
}
