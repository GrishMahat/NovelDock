...
Future<String?> showAddBookmarkDialog(BuildContext context, {required String chapterName}) {
  ...
  return showDialog<String>(
    ...
    builder: (ctx) => AlertDialog(
      ...
      content: Column(
        ...
        children: [
          Text(chapterName, style: const TextStyle(fontSize: 13, color: AppTheme.kTextSecondaryDark)),
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  onTap: () {
                    ...
                    final chIdx = chapters.indexWhere((c) => c.id == bm.chapterId);
                    if (chIdx >= 0) {
