...
void main() {
  ...
  Future<void> runCase(
    ...
    final lastBoundaries = controller.chunks.isNotEmpty
        ? controller.boundariesForTest[controller.chunks.length - 1]
        : null;
    ...
    debugPrint(
      '[$label] player: pos=${pos.inMilliseconds}ms '
